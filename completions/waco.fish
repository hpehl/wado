...
complete -c waco -n "__fish_waco_needs_command" -f -a "images" -d 'List all available standalone, domain and host controller images'
...
complete -c waco -n "__fish_waco_using_subcommand images" -s h -l help -d 'Print help'
complete -c waco -n "__fish_waco_using_subcommand images" -s V -l version -d 'Print version'
complete -c waco -n "__fish_waco_using_subcommand ps" -l standalone -d 'List standalone containers only'
complete -c waco -n "__fish_waco_using_subcommand ps" -l domain -d 'List domain controller and host controller containers only'
...
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "build" -d 'Build images'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "push" -d 'Push images'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "start" -d 'Start a standalone server'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "stop" -d 'Stop a standalone server'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "dc" -d 'Start and stop a domain controller'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "hc" -d 'Start and stop a host controller'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "topology" -d 'Start and stop a topology defined in YAML'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "images" -d 'List all available standalone, domain and host controller images'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "ps" -d 'List running standalone, domain and host controller containers'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "console" -d 'Open the management console'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "cli" -d 'Connect to the CLI'
complete -c waco -n "__fish_waco_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
