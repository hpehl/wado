...
function __fish_wado_global_optspecs
	string join \n h/help V/version
end

function __fish_wado_needs_command
	# Figure out if the current invocation already has a command.
	set -l cmd (commandline -opc)
	set -e cmd[1]
	argparse -s (__fish_wado_global_optspecs) -- $cmd 2>/dev/null
	or return
	if set -q argv[1]
...
complete -c wado -n "__fish_wado_needs_command" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_needs_command" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_needs_command" -f -a "build" -d 'Build images'
complete -c wado -n "__fish_wado_needs_command" -f -a "push" -d 'Push images'
complete -c wado -n "__fish_wado_needs_command" -f -a "start" -d 'Start a standalone server'
complete -c wado -n "__fish_wado_needs_command" -f -a "stop" -d 'Stop a standalone server'
complete -c wado -n "__fish_wado_needs_command" -f -a "dc" -d 'Start and stop a domain controller'
complete -c wado -n "__fish_wado_needs_command" -f -a "hc" -d 'Start and stop a host controller'
complete -c wado -n "__fish_wado_needs_command" -f -a "topology" -d 'Start and stop a topology defined in YAML'
complete -c wado -n "__fish_wado_needs_command" -f -a "images" -d 'List all available standalone, domain and host controller images'
complete -c wado -n "__fish_wado_needs_command" -f -a "ps" -d 'List running standalone, domain and host controller containers'
...
complete -c wado -n "__fish_wado_using_subcommand build" -l standalone -d 'Build standalone images only'
...
complete -c wado -n "__fish_wado_using_subcommand start" -s o -l offset -d 'The offset added to the published HTTP and management ports. Not allowed when multiple versions are specified.' -r
complete -c wado -n "__fish_wado_using_subcommand start" -l operations -d 'A comma seperated list of operations to bootstrap the standalone server. Can be provided multiple times.' -r
...
complete -c wado -n "__fish_wado_using_subcommand stop" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand dc; and not __fish_seen_subcommand_from start stop help" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_using_subcommand dc; and not __fish_seen_subcommand_from start stop help" -s V -l version -d 'Print version'
...
complete -c wado -n "__fish_wado_using_subcommand dc; and __fish_seen_subcommand_from stop" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand dc; and __fish_seen_subcommand_from help" -f -a "start" -d 'Start a domain controller'
complete -c wado -n "__fish_wado_using_subcommand dc; and __fish_seen_subcommand_from help" -f -a "stop" -d 'Stop a domain controller'
complete -c wado -n "__fish_wado_using_subcommand dc; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wado -n "__fish_wado_using_subcommand hc; and not __fish_seen_subcommand_from start stop help" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_using_subcommand hc; and not __fish_seen_subcommand_from start stop help" -s V -l version -d 'Print version'
...
complete -c wado -n "__fish_wado_using_subcommand hc; and __fish_seen_subcommand_from start" -s p -l password -d 'The password to connect to the domain controller' -r
complete -c wado -n "__fish_wado_using_subcommand hc; and __fish_seen_subcommand_from start" -s s -l server -d 'Manage servers of the host controller. Servers are specified as a comma seperated list of <name>[:<server-group>][:<offset>][:start].  The option can be specified multiple times.  <name>          The name of the server. This part is mandatory and must be first.                 All other parts are optional. <server-group>  The name of the server group. Allowed values are \'main-server-group\' or \'msg\',                 and \'other-server-group\' or \'osg\'. If not specified, \'main-server-group\' is used. <offset>        The port offset. If not specified, 100 is used from the second server onwards. start           Whether to start the server.' -r
complete -c wado -n "__fish_wado_using_subcommand hc; and __fish_seen_subcommand_from start" -l operations -d 'A comma seperated list of operations to bootstrap the host controller. Can be provided multiple times.' -r
...
complete -c wado -n "__fish_wado_using_subcommand hc; and __fish_seen_subcommand_from stop" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand hc; and __fish_seen_subcommand_from help" -f -a "start" -d 'Start a host controller'
complete -c wado -n "__fish_wado_using_subcommand hc; and __fish_seen_subcommand_from help" -f -a "stop" -d 'Stop a host controller'
complete -c wado -n "__fish_wado_using_subcommand hc; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wado -n "__fish_wado_using_subcommand topology; and not __fish_seen_subcommand_from start stop help" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_using_subcommand topology; and not __fish_seen_subcommand_from start stop help" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand topology; and not __fish_seen_subcommand_from start stop help" -f -a "start" -d 'Start a topology'
complete -c wado -n "__fish_wado_using_subcommand topology; and not __fish_seen_subcommand_from start stop help" -f -a "stop" -d 'Stop a topology'
complete -c wado -n "__fish_wado_using_subcommand topology; and not __fish_seen_subcommand_from start stop help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wado -n "__fish_wado_using_subcommand topology; and __fish_seen_subcommand_from start" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_using_subcommand topology; and __fish_seen_subcommand_from start" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand topology; and __fish_seen_subcommand_from stop" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_using_subcommand topology; and __fish_seen_subcommand_from stop" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand topology; and __fish_seen_subcommand_from help" -f -a "start" -d 'Start a topology'
complete -c wado -n "__fish_wado_using_subcommand topology; and __fish_seen_subcommand_from help" -f -a "stop" -d 'Stop a topology'
complete -c wado -n "__fish_wado_using_subcommand topology; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wado -n "__fish_wado_using_subcommand images" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_using_subcommand images" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand ps" -l standalone -d 'List standalone containers only'
...
complete -c wado -n "__fish_wado_using_subcommand cli" -s p -l password -d 'The password to connect to the CLI' -r
complete -c wado -n "__fish_wado_using_subcommand cli" -s h -l help -d 'Print help'
complete -c wado -n "__fish_wado_using_subcommand cli" -s V -l version -d 'Print version'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "build" -d 'Build images'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "push" -d 'Push images'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "start" -d 'Start a standalone server'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "stop" -d 'Stop a standalone server'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "dc" -d 'Start and stop a domain controller'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "hc" -d 'Start and stop a host controller'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "topology" -d 'Start and stop a topology defined in YAML'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "images" -d 'List all available standalone, domain and host controller images'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "ps" -d 'List running standalone, domain and host controller containers'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "console" -d 'Open the management console'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "cli" -d 'Connect to the CLI'
complete -c wado -n "__fish_wado_using_subcommand help; and not __fish_seen_subcommand_from build push start stop dc hc topology images ps console cli help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c wado -n "__fish_wado_using_subcommand help; and __fish_seen_subcommand_from dc" -f -a "start" -d 'Start a domain controller'
complete -c wado -n "__fish_wado_using_subcommand help; and __fish_seen_subcommand_from dc" -f -a "stop" -d 'Stop a domain controller'
complete -c wado -n "__fish_wado_using_subcommand help; and __fish_seen_subcommand_from hc" -f -a "start" -d 'Start a host controller'
complete -c wado -n "__fish_wado_using_subcommand help; and __fish_seen_subcommand_from hc" -f -a "stop" -d 'Stop a host controller'
complete -c wado -n "__fish_wado_using_subcommand help; and __fish_seen_subcommand_from topology" -f -a "start" -d 'Start a topology'
complete -c wado -n "__fish_wado_using_subcommand help; and __fish_seen_subcommand_from topology" -f -a "stop" -d 'Stop a topology'
