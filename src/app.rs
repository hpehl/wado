    ...
    Command::new(crate_name!())
        ...
        .subcommand(Command::new("start")
            ...
            .arg(Arg::new("name")
                .short('n')
                .long("name")
                .help("The name of the standalone server [default: waco-sa-<major><minor>].
        ...
        .subcommand(Command::new("dc")
            ...
            .subcommand(Command::new("start")
                ...
                .arg(Arg::new("name")
                    .short('n')
                    .long("name")
                    .help("The name of the domain controller [default: waco-dc-<major><minor>].
Not allowed when multiple versions are specified."))
                .arg(Arg::new("http")
                    .short('p')
                    .long("http")
        ...
        .subcommand(Command::new("hc")
            ...
            .subcommand(Command::new("start")
                ...
                .arg(Arg::new("name")
                    .short('n')
                    .long("name")
                    .help("The name of the host controller [default: waco-hc-<major><minor>].
Not allowed when multiple versions are specified."))
...
If omitted the console is opened for all running standalone and domain controller containers."))
            .arg(Arg::new("name")
                .short('n')
                .long("name")
                .help("The name of the standalone server or domain controller [default: waco-sa|dc-<major><minor>].
Not allowed when multiple versions are specified."))
            .arg(Arg::new("management")
                .short('m')
                .long("management")
