    ...
    Command::new(crate_name!())
        ...
        .subcommand(Command::new("build")
            ...
            .arg(Arg::new("username")
                ...
                .long("username")
                .default_value("admin")
                .help("The username of the management user [default: admin, for local dev only]"))
            .arg(Arg::new("password")
                .short('p')
                .long("password")
                .default_value("admin")
                .help("The password of the management user [default: admin, for local dev only]"))
            ...
            .arg(Arg::new("wildfly-branch")
                .long("wildfly-branch")
                .default_value("main")
                .help("The WildFly branch to build from (only used for dev builds)"))
            .arg(Arg::new("hal-branch")
                .long("hal-branch")
                .default_value("main")
                .help("The HAL console branch to build from (only used for dev builds)"))
            .arg(Arg::new("verbose")
                .short('v')
                .long("verbose")
                .action(ArgAction::SetTrue)
                .help("Print build output directly to stdout instead of using progress spinners (useful for CI)")))
        ...
        .subcommand(Command::new("start")
            ...
            .arg(Arg::new("name")
                .short('n')
                .long("name")
                .help("The name of the standalone server [default: wado-sa-<major><minor>].
        ...
        .subcommand(Command::new("dc")
            ...
            .subcommand(Command::new("start")
                ...
                .arg(Arg::new("name")
                    .short('n')
                    .long("name")
                    .help("The name of the domain controller [default: wado-dc-<major><minor>].
Not allowed when multiple versions are specified."))
                .arg(Arg::new("http")
                    .short('p')
                    .long("http")
        ...
        .subcommand(Command::new("hc")
            ...
            .subcommand(Command::new("start")
                ...
                .arg(Arg::new("name")
                    .short('n')
                    .long("name")
                    .help("The name of the host controller [default: wado-hc-<major><minor>].
Not allowed when multiple versions are specified."))
...
If omitted the console is opened for all running standalone and domain controller containers."))
            .arg(Arg::new("name")
                .short('n')
                .long("name")
                .help("The name of the standalone server or domain controller [default: wado-sa|dc-<major><minor>].
Not allowed when multiple versions are specified."))
            .arg(Arg::new("management")
                .short('m')
                .long("management")
...
Supported shells: bash, zsh, fish, elvish, powershell"))
        ...
        .subcommand(Command::new("update")
            .about("Update WildFly version data"))
